class SLA:
    ...
    def is_sla_compliant(self, average_availability: float, total_breaks: int, total_break_time: float, max_break_time: float) -> bool:
        """
        ...
        :param total_break_time: the longest single downtime duration
